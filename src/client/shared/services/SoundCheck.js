...
class SoundCheck extends Service {
  ...
  onCheckResult(result) {
    ...
    if (result === false) {
      ...
      // play touch sound
      this.touchSrc = audioContext.createBufferSource();
      this.touchSrc.buffer = this.audioBufferManager.data.soundcheckTouch;
      this.touchSrc.connect(audioContext.destination);
      this.touchSrc.start();
